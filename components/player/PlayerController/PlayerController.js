...
const createPlaybackActions = (inspect, setProperties, play) => {
...
class PlayerController extends React.Component {
  constructor(_props) {
    ...
    _defineProperty(this, "play", () => this.state.play());
  ...
  componentDidMount() {
    ...
    if (onReady) {
      onReady(createPlaybackActions(() => this.inspect(), props => this.setProperties(props), () => this.play()));
    }
  }
